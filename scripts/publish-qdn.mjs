...
const ENV_PREFIX = 'QORTIUM_CHIBIHUB';
const DEFAULT_NODE_API_URL = 'http://127.0.0.1:24891';
const DEFAULT_NAME = 'ChibiHub';
const DEFAULT_IDENTIFIER = 'ChibiHub';
const DEFAULT_TITLE = 'ChibiHub';
const DEFAULT_DESCRIPTION = 'A QDN app for Qortium: ChibiHub.';
...
async function ensureNameRegistered(name, account) {
  ...
  const rawRegisterBytes58 = buildRegisterNameRawBytes58({
    ...
    data: JSON.stringify({
      app: DEFAULT_TITLE,
      purpose: 'QDN app preview for ChibiHub',
    }),
  });
